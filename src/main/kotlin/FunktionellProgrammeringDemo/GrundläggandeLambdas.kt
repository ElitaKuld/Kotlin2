...
// Sigruns kod från filmen om Lambdas
...
fun main(){
    ...
    println(list1.count{it < 20}) // snabb variant

    println(list1.filter({it < 20}).any())

    println(list1.any{it < 20}) // snabb variant
    ...
    val p = 4    //closure
    val isDividableBy4 = {i : Int -> i % p == 0}
    println(list1.filter(isDividableBy4))
